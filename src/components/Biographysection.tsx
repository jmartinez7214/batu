...
export const Biographysection = (): JSX.Element => {
  ...
  return (
    <div className="container mx-auto px-4 pt-16" id="biography">
      ...
      >
        <h2 className="text-5xl text-center mb-4">BIOGRAFÍA</h2>
        ...
        <div className="text-justify">
          ...
          <p>
            ...
            el festival más grande de Rock &amp; Metal de República Dominicana.
            Posteriormente, fueron una de las bandas elegidas para participar en
            el Tripletazo Diabólico, realizado en el Portal de la Zona Colonial,
            el 27 de diciembre del 2019.
          </p>
          <p>
            ...
            producción, el &quot;Vol.3 Corruptopía&quot;, una historia sobre las
          ...
          <p>
            ...
            fanáticos en plena pandemia, en segundo lugar, pero primero en el
            gusto de los fans de la escena metalera fue Mono Mascara, un tema
            inspirado en el asesinato de un civil por este no llevar la
            mascarilla puesta.
          </p>
          <p>
            Vol.4 Toxicolandia la banda siguió retomando los temas de protesta
            social y fue además, una catarsis que de la banda ante todas las
